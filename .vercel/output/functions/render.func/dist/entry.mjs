...
const _page0  = () => import('./chunks/index@_@astro.5f74c046.mjs');
const _page1  = () => import('./chunks/abby-chat@_@ts.c1840e12.mjs');const pageMap = new Map([["src/pages/index.astro", _page0],["src/pages/api/abby-chat.ts", _page1]]);
const _manifest = Object.assign(deserializeManifest({"adapterName":"@astrojs/vercel/serverless","routes":[{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"/_astro/index.6daed558.css"}],"routeData":{"route":"/","type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":false,"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/abby-chat","type":"endpoint","pattern":"^\\/api\\/abby-chat$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"abby-chat","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/abby-chat.ts","pathname":"/api/abby-chat","prerender":false,"_meta":{"trailingSlash":"ignore"}}}],"base":"/","compressHTML":false,"markdown":{"drafts":false,"syntaxHighlight":"shiki","shikiConfig":{"langs":[],"theme":"github-dark","wrap":false},"remarkPlugins":[],"rehypePlugins":[],"remarkRehype":{},"gfm":true,"smartypants":true},"componentMetadata":[["C:/Users/DELL/Desktop/FUN/src/pages/index.astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var i=t=>{let e=async()=>{await(await t())()};\"requestIdleCallback\"in window?window.requestIdleCallback(e):setTimeout(e,200)};(self.Astro||(self.Astro={})).idle=i;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var s=(i,t)=>{let a=async()=>{await(await i())()};if(t.value){let e=matchMedia(t.value);e.matches?a():e.addEventListener(\"change\",a,{once:!0})}};(self.Astro||(self.Astro={})).media=s;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var r=(i,c,n)=>{let s=async()=>{await(await i())()},t=new IntersectionObserver(e=>{for(let o of e)if(o.isIntersecting){t.disconnect(),s();break}});for(let e of n.children)t.observe(e)};(self.Astro||(self.Astro={})).visible=r;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"\u0000@astrojs-ssr-virtual-entry":"_@astrojs-ssr-virtual-entry.mjs","\u0000@astro-renderers":"renderers.mjs","\u0000empty-middleware":"_empty-middleware.mjs","/src/pages/api/abby-chat.ts":"chunks/pages/abby-chat.ts.1430274a.mjs","/src/pages/index.astro":"chunks/pages/index.astro.87f58936.mjs","C:/Users/DELL/Desktop/FUN/node_modules/@astrojs/react/vnode-children.js":"chunks/vnode-children.5a6df93a.mjs","\u0000@astro-page:src/pages/index@_@astro":"chunks/index@_@astro.5f74c046.mjs","\u0000@astro-page:src/pages/api/abby-chat@_@ts":"chunks/abby-chat@_@ts.c1840e12.mjs","C:/Users/DELL/Desktop/FUN/src/components/ChatWindow.tsx":"_astro/ChatWindow.be35faf2.js","@astrojs/react/client.js":"_astro/client.172a8609.js","astro:scripts/before-hydration.js":""},"assets":["/_astro/index.6daed558.css","/styles.css","/_astro/ChatWindow.be35faf2.js","/_astro/client.172a8609.js","/_astro/index.b2a7ed32.js"]}), {
	pageMap,
	renderers,
});
